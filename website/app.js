...
const generatedData = () => {
  ...
  getWeather(zipp).then((data) => {
    //validating the date and complete our processes.
...
// configure a click listner to add functionality to our DOM
